...
class ChatHistory(models.Model):
    ...
    INTENT_CHOICES = [
        ...
        ('document_suggestion', 'Document Suggestion'),
        ('error', 'Error'),
    ]
    ...
    is_helpful = models.BooleanField(null=True, blank=True, help_text='User feedback: True for helpful, False for not helpful')
    feedback = models.TextField(blank=True, null=True, help_text='User feedback comments')
...
class Document(models.Model):
    ...
    file_path = models.CharField(max_length=500, help_text='Path to uploaded file', null=True, blank=True)
    file_name = models.CharField(max_length=255)
    file_size = models.IntegerField(help_text='File size in bytes', default=0)
    blob_content = models.BinaryField(null=True, blank=True, help_text='Compressed file content stored as BLOB')
    is_compressed = models.BooleanField(default=False, help_text='Whether the BLOB content is compressed with zlib')
    ...
    target_years = models.JSONField(default=list, blank=True, help_text='List of academic years (e.g., 1st Year, 2nd Year)')
